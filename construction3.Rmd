...
write.table(resun, file="matrice_distt_1020Struct.csv", col.names = T, row.names=T, quote=FALSE,sep = ",")
toto<- read.csv("matrice_distt_1020Struct.csv")
```
...
```{r}
resun <- read.table("~/Bureau/projet_long/analyse2/matrice_distt_1020Struct.csv", comment.char="", sep=";")
```

```{r}
which(is.na(resunn),arr.ind=TRUE)
resunn<-resunn[,1:2415]
```
...
```{r}
#resunn<- read.table("~/Bureau/projet_long/analyse2/matrice_distt_1020Struct.csv", quote="\"", comment.char="", sep=',')
cor_X = cor(resunn)
...
resu2 <- resunn[,-var.Supp]
dim(resu2)
write.table(resu2, "matrice_dist_filter.csv")
resfff <- read.table("~/Bureau/projet_long/analyse2/matrice_dist_filter.csv", quote="\"", comment.char="")
```
...
write.table(resun, file="matrice_angA_1020Struct.csv", col.names = T, row.names=T, quote=FALSE,sep = ",")
toto<- read.csv("matrice_angA_1020Struct.csv")
```
